...
Also see [Polyglot Modeling](https://github.com/json-ld/yaml-ld/issues/19) ⭐ 40 | 🐛 38 | 🌐 HTML | 📅 2026-07-28 tools (issue in the YAML-LD project). Sometimes called **SchemaOps**; the name "schema salad" is used sometimes ;-)
