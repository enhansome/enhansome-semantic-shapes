...
* [pySHACL](https://github.com/rdflib/pyshacl) ⭐ 340 | 🐛 45 | 🌐 Python | 📅 2026-07-28 <img alt="Release Date" src="https://img.shields.io/github/release-date/rdflib/pyshacl" align="top"> - pySHACL: A Python validator for SHACL. One of the most comprehensive SHACL implementations. Uses [RDFLib](https://github.com/rdflib/rdflib) ⭐ 2,499 | 🐛 373 | 🌐 Python | 📅 2026-08-24 for working with RDF and [OWL-RL library](https://github.com/rdflib/owl-rl) ⭐ 178 | 🐛 25 | 🌐 HTML | 📅 2026-08-06 for OWL2 RL Profile-based expansion of data graphs; `Apache` license; `Python`.
