...
* [shacl-engine](https://github.com/rdf-ext/shacl-engine) ⭐ 59 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-03 <img alt="NPM Version" src="https://img.shields.io/npm/v/shacl-engine" align="top"> <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/rdf-ext/shacl-engine" align="top"> - Supports SHACL Core, SHACL-SPARQL, Experimental [SHACL 1.2](https://www.w3.org/TR/shacl12-core/) support ([shacl-engine experimental](https://github.com/rdf-ext/shacl-engine/tree/experimental) ⭐ 59 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-03); 15-26x faster than other JavaScript or Python packages ([blog post](https://www.bergnet.org/2023/03/2023/shacl-engine/), [real-world examples](https://github.com/rdf-ext/shacl-engine/issues/12#issuecomment-1940875628) ⭐ 59 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-03); works on data provided as [RDF/JS](http://rdf.js.org/data-model-spec/) objects; `MIT` license; `JavaScript`.
  * [rdf-ext-cli](https://github.com/rdf-ext/rdf-ext-cli) ⭐ 5 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-03 - Command line tool for validation. Data and shapes can be given as file, URL, or SPARQL endpoint + query.
...
Also see [Polyglot Modeling](https://github.com/json-ld/yaml-ld/issues/19) ⭐ 41 | 🐛 38 | 🌐 HTML | 📅 2026-09-10 tools (issue in the YAML-LD project). Sometimes called **SchemaOps**; the name "schema salad" is used sometimes ;-)
...
* ShEx
  * [ShEx Text Suite](https://github.com/shexSpec/shexTest) ⭐ 3 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-03 and [website](https://shexspec.github.io/shexTest/) - Version `next@1.0.2`, last release 5 October 2018.
