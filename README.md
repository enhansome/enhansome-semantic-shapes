...
Also see [Polyglot Modeling](https://github.com/json-ld/yaml-ld/issues/19) ⭐ 41 | 🐛 40 | 🌐 HTML | 📅 2026-09-24 tools (issue in the YAML-LD project). Sometimes called **SchemaOps**; the name "schema salad" is used sometimes ;-)
...
* ShEx
  * [ShEx Text Suite](https://github.com/shexSpec/shexTest) ⭐ 3 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-24 and [website](https://shexspec.github.io/shexTest/) - Version `next@1.0.2`, last release 5 October 2018.
