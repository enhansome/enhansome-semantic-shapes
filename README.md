...
* [shacl-engine](https://github.com/rdf-ext/shacl-engine) ⭐ 59 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-13 <img alt="NPM Version" src="https://img.shields.io/npm/v/shacl-engine" align="top"> <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/rdf-ext/shacl-engine" align="top"> - Supports SHACL Core, SHACL-SPARQL, Experimental [SHACL 1.2](https://www.w3.org/TR/shacl12-core/) support ([shacl-engine experimental](https://github.com/rdf-ext/shacl-engine/tree/experimental) ⭐ 59 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-13); 15-26x faster than other JavaScript or Python packages ([blog post](https://www.bergnet.org/2023/03/2023/shacl-engine/), [real-world examples](https://github.com/rdf-ext/shacl-engine/issues/12#issuecomment-1940875628) ⭐ 59 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-13); works on data provided as [RDF/JS](http://rdf.js.org/data-model-spec/) objects; `MIT` license; `JavaScript`.
